...
const uint64_t part1Expected = 14;
const uint64_t part2Expected = 34;
...
int main(int argc, char **argv)
{
    ...
    if (result == 0)
    {
        ...
        std::cout << "--------------------------------------------------------------------------------------------------------" << std::endl;
#if ENABLE_PART1
        std::cout << "Day 8, running solution:" << std::endl;
