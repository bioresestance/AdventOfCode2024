...
const std::vector<std::string> testInputStrings = {"89010123",
                                                   "78121874",
                                                   "87430965",
                                                   "96549874",
                                                   "45678903",
...
const uint64_t part1Expected = 36;
const uint64_t part2Expected = 81;
...
int main(int argc, char **argv)
{
    ...
    if (result == 0)
    {
        ...
        std::cout << "--------------------------------------------------------------------------------------------------------" << std::endl;
#if ENABLE_PART1
        std::cout << "Day 10, running solution:" << std::endl;
