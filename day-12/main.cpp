...
const std::vector<std::string> testInputStrings = {"RRRRIICCFF",
                                                   "RRRRIICCCF",
                                                   "VVRRRCCFFF",
                                                   "VVRCCCJFFF",
                                                   "VVVVCJJCFE",
...
const uint64_t part1Expected = 1930;
const uint64_t part2Expected = 1206;
...
int main(int argc, char **argv)
{
    ...
    if (result == 0)
    {
        ...
        std::cout << "--------------------------------------------------------------------------------------------------------" << std::endl;
#if ENABLE_PART1
        std::cout << "Day 12, running solution:" << std::endl;
