...
const std::vector<std::string> testInputStrings = {"125 17"};

const uint64_t part1Expected = 55312;
...
int main(int argc, char **argv)
{
    ...
    if (result == 0)
    {
        ...
        std::cout << "--------------------------------------------------------------------------------------------------------" << std::endl;
#if ENABLE_PART1
        std::cout << "Day 11, running solution:" << std::endl;
