...
const int64_t part1Expected = 7036;
const int64_t part2Expected = 45;
...
int main(int argc, char **argv)
{
    ...
    if (result == 0)
    {
        ...
        std::cout << "--------------------------------------------------------------------------------------------------------" << std::endl;
#if ENABLE_PART1
        std::cout << "Day 16, running solution:" << std::endl;
